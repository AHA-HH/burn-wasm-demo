...
// Trained parameters in the burnpack format, produced by `examples/export/web_demo.rs`
// (`model.into_record().save(..)`) in the sciml-rs crate and copied here. Regenerate
// with the same command if the model architecture changes.
